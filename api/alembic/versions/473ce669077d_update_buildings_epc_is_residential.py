...
def upgrade() -> None:
    ...
    """Update building_epc query definition"""
    ...
    op.execute("DROP MATERIALIZED VIEW IF EXISTS iris.building_epc;")
    ...
    op.execute(
        """
        REFRESH MATERIALIZED VIEW iris.uk_ward_epc_data;
        REFRESH MATERIALIZED VIEW iris.uk_region_epc_data;
        REFRESH MATERIALIZED VIEW iris.district_borough_unitary_epc_data;
        REFRESH MATERIALIZED VIEW iris.boundary_line_ceremonial_counties_epc_data;
        """
    )

    op.execute(
        """
        REFRESH MATERIALIZED VIEW iris.uk_ward_epc;
        REFRESH MATERIALIZED VIEW iris.uk_region_epc;
        REFRESH MATERIALIZED VIEW iris.district_borough_unitary_epc;
        REFRESH MATERIALIZED VIEW iris.boundary_line_ceremonial_counties_epc;
        """
    )
    pass
