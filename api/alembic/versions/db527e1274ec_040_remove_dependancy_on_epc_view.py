...
"""040_remove_dependancy_on_epc_view
...
def _create_downgrade_building_extreme_weather_analytics_view():
    op.execute(
        """
        CREATE MATERIALIZED VIEW iris.building_extreme_weather_analytics AS (
            WITH buildings_affected_by_icing_days AS (
...
def downgrade() -> None:
    ...
    _create_building_weather_analytics_view_indices()
    _create_downgrade_building_extreme_weather_analytics_view()
