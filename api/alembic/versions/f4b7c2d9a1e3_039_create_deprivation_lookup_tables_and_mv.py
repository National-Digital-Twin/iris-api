...
def upgrade() -> None:
    ...
    op.execute(
        ...
        (
            id integer NOT NULL DEFAULT nextval('msoa_boundaries_id_seq'::regclass),
    ...
    op.execute(
        """
        ALTER TABLE IF EXISTS iris.msoa_boundaries
            OWNER to iris;
        """
    )
    op.execute(
    ...
    op.execute(
        ...
        (
            id integer NOT NULL DEFAULT nextval('oa_boundaries_analytics_id_seq'::regclass),
    ...
    op.execute(
        """
        ALTER TABLE IF EXISTS iris.oa_boundaries_analytics
            OWNER to iris;
        """
    )
    op.execute(
    ...
    op.execute(
        """
        ALTER TABLE IF EXISTS iris.ons_deprivation_metrics
            OWNER to iris;
        """
    )
    ...
    op.execute(
        """
        ALTER TABLE IF EXISTS iris.ons_deprivation_metrics_analytics
            OWNER to iris;
        """
    )
    ...
    op.execute(
        """
        ALTER TABLE IF EXISTS iris.msoa_deprivation_data
            OWNER TO iris;
        """
    )
    ...
    op.execute(
        """
        ALTER TABLE IF EXISTS iris.msoa_deprivation_geojson
            OWNER TO iris;
        """
    )
    ...
    op.execute(
        """
        ALTER TABLE IF EXISTS iris.oa_area_membership_mv
            OWNER TO iris;
        """
    )
